...
<div class="container">
    ...
    <section class="hero">
        <p>
            Somos una empresa dedicada a la venta de equipos celulares de todas las gamas. Nuestro objetivo es ofrecer equipos libres para que no tengan que firmar contratos ni planes que a la larga les saldrían más dinero. Nuestros equipos los podrán usar con cualquier operador y en cualquier país sin restricciones de ningún tipo.
        </p>
    </section>
